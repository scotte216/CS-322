...
*/
  ...
  static CodePack gen(Ast1.Binop n) throws Exception {
    ...
    if (bop == IR1.AOP.OR)
    {
        ...
        code.add(new IR1.Move(temp, IR1.TRUE));

        code.addAll(e1.code);

        code.add(new IR1.CJump(IR1.ROP.EQ, e1.src, IR1.TRUE, l));
    ...
    else if (bop == IR1.AOP.AND)
    {
        CodePack e1 = gen(n.e1);
        IR1.Label l = new IR1.Label();
        temp = new IR1.Temp();
        code.add(new IR1.Move(temp, IR1.FALSE));

        code.addAll(e1.code);

        code.add(new IR1.CJump(IR1.ROP.EQ, e1.src, IR1.FALSE, l));
    ...
    { 
        ...
        code.addAll(e1.code);
        code.addAll(e2.code);
        IR1.Binop result = new IR1.Binop(gen(n.op), temp, e1.src, e2.src);
        code.add(result);
    }    
